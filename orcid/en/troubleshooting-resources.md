...
## Users sent to authenticate at ORCID cannot do so, due to integration error

Redirect URIs are used by ORCID's authentication service as a security measure. This prevents services from impersonating each other. You must register all redirect URI: [see instructions to update or request new redirect URI(s)](https://docs.pkp.sfu.ca/orcid/en/installation-setup#orcid-redirect-uris).
